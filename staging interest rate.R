...
interest_rate_file <- "data/raw/interest rates/interest rate eurostat yearly irt_st_m_22063167.xlsx"
...
interest_rate_3m_yearly <- read_excel(
  ...
  filter(!is.na(time), !is.na(rate_3m)) |>
  mutate(
...
write_xlsx(interest_rate_3m_yearly, "data/interest_rate_3m_yearly.xlsx")
